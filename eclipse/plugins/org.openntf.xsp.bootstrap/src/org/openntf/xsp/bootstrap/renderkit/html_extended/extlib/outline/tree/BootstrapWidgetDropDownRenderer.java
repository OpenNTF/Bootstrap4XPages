...
public class BootstrapWidgetDropDownRenderer extends BootstrapTreePopupMenuRenderer {
    
    private static final long serialVersionUID = 1L;

    public BootstrapWidgetDropDownRenderer() {
    }
    ...
    protected void renderPopupButton(FacesContext context, ResponseWriter writer, TreeContextImpl tree, boolean enabled, boolean selected) throws IOException {
        ...
        writer.writeAttribute("src", HtmlRendererUtil.getImageURL(context,"/.ibmxspres/.extlib/bootstrap/icons/widget_dropdown.png"), null); // $NON-NLS-1$
