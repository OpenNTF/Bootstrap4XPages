...
/**
 * Boostrap4XPages library fragment.
 * 
 * @author priand
 */
public abstract class BootstrapFragment {
	
    public static final String EXTENSION_NAME = "com.ibm.xsp.extlibx.bootstrap.fragment"; // $NON-NLS-1$
