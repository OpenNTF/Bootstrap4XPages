...
public class BootstrapDropDownButtonRenderer extends OutlineDropDownButtonRenderer {

    @Override
    protected ITreeRenderer findTreeRenderer(FacesContext context, AbstractOutline outline) {
        return new org.openntf.xsp.bootstrap.renderkit.html_extended.extlib.outline.tree.BootstrapDropDownButtonRenderer();
    }
}