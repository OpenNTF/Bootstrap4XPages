...
public class BootstrapAccordionRenderer3 extends AbstractTreeRenderer {
    ...
    public BootstrapAccordionRenderer3(String accordionClientId) {
    ...
    protected void preRenderTree(FacesContext context, ResponseWriter writer, TreeContextImpl tree) throws IOException {
        ...
        writer.writeAttribute("class","panel-group",null); // $NON-NLS-1$
