...
import com.ibm.xsp.extlib.renderkit.html_extended.outline.tree.SortLinksRenderer;


public class BootstrapSortLinksRenderer extends SortLinksRenderer {
    ...
    public BootstrapSortLinksRenderer() {
    }

    public BootstrapSortLinksRenderer(UIComponent component) {
        super(component);
    }
}