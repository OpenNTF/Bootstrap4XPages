...
public class BootstrapLinksListRenderer extends LinksListRenderer {
    ...
    public BootstrapLinksListRenderer() {
    }

    public BootstrapLinksListRenderer(UIComponent component) {
        super(component);
    }
